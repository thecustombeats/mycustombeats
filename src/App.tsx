      ...
      <div className="relative min-h-screen bg-ivory">
        ...
        <main className="relative">
          ...
          <section className="py-20 px-6 bg-[#FBF9F6] text-center">
            ...
            <a
              href="/products"
              className="group mt-16 md:mt-20 px-10 py-4 bg-gold text-espresso rounded-full font-medium transition-all duration-300 hover:bg-espresso hover:text-ivory hover:scale-105 shadow-md hover:shadow-xl inline-flex items-center gap-2"
            >
