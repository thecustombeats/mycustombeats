...
export const LEGAL_REVIEW_REQUIRED: readonly ReviewItem[] = [
  ...
  {
    topic: "SINGLE CREATIVE AUTHORITY — Terms/Refunds 2026-09-15.2, Privacy 2026-09-15 and the Creative Authority checkout statement",
    positionTaken:
      "Founder executive decision (15 September 2026): no customer song or artwork approval, no drafts, no included subjective revisions; personalised production begins at verified payment; MCB internal quality control gates reveal and manufacture. Implemented as: a separate required, un-ticked CREATIVE_AUTHORITY consent using the Founder-approved wording, versioned (2026-09-15) and recorded with its time; Terms clauses 4 (Creative authority), 5 (Personalised production and the reveal), 6 (Creative preference and genuine problems), 7 (cancelling, with 'cancellation/refund rights may be limited as permitted by applicable law' and 'Nothing in these terms affects any statutory rights that cannot legally be excluded or limited.'), 9 (customer responsibility for supplied information). A specifically chosen music style is treated as part of the customer's specification. Clauses 18 and 20 are unchanged.",
    question:
      "NEEDS PROFESSIONAL LEGAL REVIEW, jurisdiction by jurisdiction (UK first; EU and US cruise guests): (1) whether the Creative Authority statement and clause 6 fairly and enforceably distinguish subjective preference from non-conformity under the Consumer Rights Act 2015 (reasonable care and skill; satisfactory quality; as described) and the unfair-terms rules; (2) whether production beginning at payment, with the SERVICE_START request and the personalised-goods and digital-content exceptions, supports clause 7 as worded; (3) whether any destination requires different pre-contract disclosure; (4) clauses 18 and 20. No legal certainty is claimed.",
    severity: "BLOCKING",
  },
  {
    topic: "LAUNCH CLOSURE Terms and Refunds edition 2026-09-15 — what changed and what did not",
    positionTaken:
      "At the Founders' instruction to correct clear internal contradictions without inventing legal rights, Terms 2026-09-15 changed only: clause 4 (refinements close at approval, matching clause 6 and the approval flow); clause 7 ('no refund policy for a change of mind' plus 'This does not affect your rights if an item arrives damaged, faulty or not as described'); clause 8 (courier disclaimer and 'take this up with the courier' replaced by the Founder-approved fulfilment position, separate-parcels note and damage guidance, which is stated not to be a condition of help); clause 17 (the 24-hour condition and 'reasonable discount price' removed — partner and carrier claim windows are MCB's to manage); clause 23 (changes apply to future orders only, as clauses 2 and 25 already promised). Refunds 2026-09-15 restates those. Items (2), (3), (4) and (5) of the entry above are addressed in wording; item (1) clause 18 (death or personal injury) and item (6) clause 20 (legal-case responsibility) are UNCHANGED because they are substantive liability terms, not internal contradictions.",
    question:
      "(1) Founder approval that the 2026-09-15 wording is commercially accurate, in particular the removal of 'a reasonable discount price' from clause 17. (2) Legal confirmation that clauses 7, 8 and 17 as now worded do not restrict statutory rights. (3) A decision on clause 18's death/personal-injury exclusion and clause 20, which remain as the Founder wrote them.",
    severity: "BLOCKING",
  },
  ...
  },
  {
    ...
    question:
      "Still required before production: (1) a retention and deletion period for each data category — identity and contact details, delivery addresses, stories and personalisation, photos, change requests and support messages, enquiries, payment and order records, and audit data — none has been decided, and none is stated, assumed or automated in the code; docs/DATA-RETENTION-ARCHITECTURE.md (Sprint 5) sets out the categories and a safe deletion and anonymisation method to apply once periods are approved; (2) Founder and legal approval of the 2026-09-14 Privacy Policy edition as now rendered, together with the UK GDPR review item above. Cloudinary is no longer an open website decision: Sprint 5 confirmed there is no active Cloudinary code in the website or API, and a regression test holds it there. Whether MCB uses Cloudinary outside this website was not assessed and is not a website release question.",
    severity: "BLOCKING",
  },
  {
