...
export const CUSTOMER_STAGES: Readonly<Record<Workflow, readonly CustomerStage[]>> = {
  ...
  PHYSICAL: [
    ...
    { id: "making", title: "Making your keepsake", description: "Your music is approved and your keepsake is being made.", states: ["FULFILMENT.PENDING", "FULFILMENT.READY", "FULFILMENT.CONFIRMED"] },
    { id: "on-its-way", title: "On its way", description: "Your order has been sent.", states: ["DISPATCHED"] },
