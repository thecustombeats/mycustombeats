...
test("no customer approval, APPROVE/REMAKE or revision path remains in the server lifecycle", () => {
  ...
  assert.match(email, /const MCB_LIFECYCLE_TYPES = \['CREATION_READY', 'IN_PRODUCTION', 'DISPATCHED', 'ADDITIONAL_PARCEL_DISPATCHED', 'DELIVERY_UPDATE', 'DELIVERED', 'VIDEO_READY', 'SUPPORT_RESPONSE', 'FOLLOW_UP'\]/);
