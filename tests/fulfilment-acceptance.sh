...
ROOTQ fcb < db/migrations/2026-09-16-business-intelligence.sql 2>/dev/null
ROOTQ fcb < db/migrations/2026-09-16-supplier-routing.sql 2>/dev/null
ROOTQ fcb < db/migrations/2026-09-17-resilience.sql 2>/dev/null
