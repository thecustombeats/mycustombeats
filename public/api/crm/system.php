...
try {
    if (($_SERVER['REQUEST_METHOD'] ?? '') === 'GET') {
        if (crm_staff_name(operations_line($_GET['staff'] ?? null, 160)) === null) {
        ...
        match ($view) {
            ...
            'payment-first' => json_response(200, ['view' => $view, 'workflows' => resilience_payment_first_matrix(), 'phases' => MCB_PAYMENT_PHASES,
                'rule' => 'MCB begins no creative or fulfilment work until payment is confirmed.']),
